...
const Services = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto bg-gray-100 min-h-screen p-4 sm:p-6" data-aos="fade-up">
      {/* Section Title */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 border border-blue-500">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 border border-blue-500">
          ...
          <p className="text-sm lg:text-base text-gray-600 leading-relaxed">
            ...
            principles, wireframing, prototyping, and ensuring brand consistency
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 border border-blue-500">
          ...
          <p className="text-sm lg:text-base text-gray-600 leading-relaxed">
            Experienced in leading projects from conception through completion,
            adhering to strict timelines and budget constraints. Adept at using
            Agile methodologies (Scrum/Kanban) to organize teams, manage
            stakeholders, mitigate risks, and ensure the delivery of
            high-quality results that meet strategic business objectives.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 border border-blue-500">
          ...
          <p className="text-sm lg:text-base text-gray-600 leading-relaxed">
            Deep understanding and practical experience with various management
            and collaboration tools (e.g., CRM, ERP, project tracking
            platforms). Capable of implementing, configuring, and optimizing
            software solutions to streamline workflows, enhance team efficiency,
